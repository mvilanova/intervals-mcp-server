...
host_override = os.getenv("FASTMCP_HOST")
port_override = os.getenv("FASTMCP_PORT")
mcp_kwargs = {}
if host_override:
    mcp_kwargs["host"] = host_override
if port_override:
    mcp_kwargs["port"] = int(port_override)

mcp = FastMCP("intervals-icu", lifespan=setup_api_client, **mcp_kwargs)
